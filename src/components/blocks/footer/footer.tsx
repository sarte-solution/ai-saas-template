...
const defaultSocialLinks = [
  {
    icon: <IconBrandInstagram stroke={1} className="size-5" />,
    href: '#',
    label: 'Instagram',
  },
  {
    icon: <IconBrandFacebook stroke={1} className="size-5" />,
    href: '#',
    label: 'Facebook',
  },
  {
  ...
  {
    icon: <IconBrandLinkedin stroke={1} className="size-5" />,
    href: '#',
    label: 'LinkedIn',
  },
]
...
export const Footer = ({
  logo = {
    ...
    alt: 'logo',
    title: 'AI SaaSr-saas.org',
  },
  sections = defaultSections,
  description = 'A collection of components for your startup business or side project.',
  socialLinks = defaultSocialLinks,
  copyright = '© 2025 AI SaaSr-SaaS. All rights reserved.',
