...
export function Features() {
  const features = [
    ...
    },
    {
      title: 'Saas Blog',
      description:
        'Multi-language, MDX-based blog to write about your product.',
    ...
    },
    {
      ...
      description:
        'Manage or Disable your user accounts within Admin dashboard.',
      icon: <IconAdjustmentsBolt />,
    },
    {
      title: 'SEO Friendly',
      description:
        'The AI SaaSr-SaaS is SEO-Ready out of the box, no extra work required',
      icon: <IconHeart />,
    },
  ]
  return (
