...
AI SaaS Template follows a well-organized project structure based on Next.js 15 App Router with clear separation of concerns and modular architecture.
...
### Internationalization (`src/translate/`)
...
├── auth/                      # Authentication components
├── payment/                   # Payment components
├── blocks/                    # Page blocks and layouts
├── layout/                    # Layout components
├── providers/                 # Context providers
└── common/                    # Common reusable components
```

With corresponding logic organized in:
...
### Tree Shaking
- Use ES modules for AI SaaSr tree shaking
