...
AI SaaS Template provides comprehensive internationalization support using next-intl, enabling multi-language applications with localized routing, dynamic content translation, and seamless language switching.
...
```typescript
// src/translate/i18n/navigation.ts
