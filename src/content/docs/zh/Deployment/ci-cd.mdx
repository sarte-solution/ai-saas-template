---
title: CI/CD 流水线
description: 使用 GitHub Actions 为 AI SaaS Template 设置自动化持续集成和部署流水线，包含测试和部署自动化
---

# CI/CD 流水线

本指南涵盖使用 GitHub Actions 为 AI SaaS Template 设置完整的 CI/CD 流水线，包括自动化测试、构建和生产环境部署。
